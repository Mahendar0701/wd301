...
const Appbar = () => {
  ...
  const toggleLanguage = () => {
    const newLanguage = i18n.language === "es" ? "en" : "es"; // Toggle between "en" and "es" language codes
    i18n.changeLanguage(newLanguage); // Change the language using i18n's changeLanguage method
    setEnabled(!enabled);
  };
